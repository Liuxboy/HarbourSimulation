package com.github.liuxboy.harbour.simulation.controller.interceptor;

import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.github.liuxboy.harbour.simulation.domain.response.BaseResponseDto;
...
public class ParamNotValidExpcetionResolver implements PriorityOrdered, HandlerExceptionResolver {
    ...
    public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) {
        ...
        try {
            ...
            outputStream.write(JSONObject.toJSONBytes(baseResponseDto, SerializerFeature.WriteNonStringKeyAsString));
        } catch (IOException e) {
            logger.error(e);
        }
